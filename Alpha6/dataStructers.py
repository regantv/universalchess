...
figuresDropBlackPos = {'r1':[-1,0],'r2':[-1,1],'n1':[-1,2],'n2':[-1,3],'b1':[-2,0],'b2':[-2,1],'q':[-2,2],'k':[-2,3],
                  'p1':[1,0],'p2':[1,1],'p3':[1,2],'p4':[1,3],'p5':[0,0],'p6':[0,1],'p7':[0,2],'p8':[0,3]}
...
figuresDropTwoWhite = [0.24829577170682565, 0.2507586313406235, 0.003950821007483035, -1.5954849677355083, -0.025717794409797958, 0.062107704913587046]
